...
import com.eventlocator.eventlocator.databinding.FragmentFilterOrganizersPreviousEventsBinding
...
class FilterOrganizersPreviousEventsFragment(var events: ArrayList<Event>): Fragment() {
    lateinit var binding:FragmentFilterOrganizersPreviousEventsBinding
    lateinit var activity: OnPreviousEventsFiltered
    var startDate: LocalDate? = null
    var endDate: LocalDate? = null
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentFilterOrganizersPreviousEventsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnApply.setOnClickListener {
            ...
            activity.getPreviousEvents(result)
    ...
    override fun onAttach(context: Context) {
        ...
        activity = context as OnPreviousEventsFiltered
    }
}

interface OnPreviousEventsFiltered{
    fun getPreviousEvents(previousEvents: ArrayList<Event>)
}